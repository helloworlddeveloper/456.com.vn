...
if (!nv_function_exists('nv_block_news_cat')) {
    ...
    function nv_block_news_cat($block_config)
    {
        ...
        if (!empty($list)) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/news/block_groups_new.tpl')) {
                $block_theme = $global_config['module_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('block_groups_new.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/news');
