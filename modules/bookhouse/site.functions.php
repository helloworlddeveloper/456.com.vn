...
{
    global $array_config, $array_money_unit;
...
{
    global $lang_module, $array_config, $array_pricetype;
        ...
        switch (count($r)) {
            case 4:
                ...
                if ((int) $r[1]) {
                    ...
                    if ($array_config['priceformat'] == 1 and $pricetime > 0) {
                        $str .= ' / ' . $array_pricetype[$pricetime]['title'];
                    }
                } else {
                    $str = $r[0];
                    if ($array_config['priceformat'] == 1 and $pricetime > 0) {
                        $str .= ' ' . $lang_module['billion'] . ' / ' . $array_pricetype[$pricetime]['title'];
                    } else {
            ...
            case 3:
                ...
                if ((int) $r[1]) {
                    ...
                    $str = $r[0];
                    if ($array_config['priceformat'] == 1 and $pricetime > 0) {
                        $str .= ' ' . $lang_module['million'] . ' / ' . $array_pricetype[$pricetime]['title'];
                    } else {
            ...
            case 2:
                ...
                if ((int) $r[1]) {
                    ...
                    $str = $r[0];
                    if ($array_config['priceformat'] == 1 and $pricetime > 0) {
                        $str .= ' ' . $lang_module['thousand'] . ' / ' . $array_pricetype[$pricetime]['title'];
                    } else {
...
if (!function_exists('nv_number_format')) {
