...
if (! nv_function_exists('nv_block_search')) {
    ...
    function nv_block_config_search($module, $data_block, $lang_block)
    {
        ...
        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/bookhouse/block_block_bookhouse_search_tab.tpl')) {
            $block_theme = $global_config['module_theme'];
        } else {
            $block_theme = 'default';
        }
        
        $xtpl = new XTemplate('block_block_bookhouse_search_tab.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/bookhouse');
    ...
    function nv_block_search($block_config, $module)
    {
        ...
        if ( $global_config['site_lang'] == 'en'){
            $block_config['price_begin'] = $block_config['price_begin']/22800;
            $block_config['price_step'] = $block_config['price_step']/22800;
            $block_config['price_end'] = $block_config['price_end']/22800;
        }
