...
<form action="{ACTION}" method="POST" id="items" class="form-horizontal">
	...
	<div class="row">
		<div class="col-md-19">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label"><strong>{LANG.phong_khach}
						</strong></label>
						<div class="col-sm-20">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label"><strong>{LANG.phong_ngu}
						</strong></label>
						<div class="col-sm-20">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label"><strong>{LANG.phong_tam}
						</strong></label>
						<div class="col-sm-20">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label"><strong>{LANG.items_hometext}</strong> <span class="red">*</span></label>
						<div class="col-sm-20">
							<textarea class="form-control" rows="5" name="hometext" required="required" oninvalid="setCustomValidity( nv_required )" oninput="setCustomValidity('')">{DATA.hometext}</textarea>
						</div>
					</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-4 control-label"><strong>{LANG.structure}</strong></label>
						<div class="col-sm-20">
							<textarea name="structure" class="form-control">{DATA.structure}</textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label"><strong>{LANG.type}</strong></label>
						<div class="col-sm-20">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-5 col-md-4 control-label"><strong>{LANG.contact_email}</strong> <span class="red">(*)</span></label>
						<div class="col-sm-19 col-md-20">
							<input class="form-control" type="email" name="contact_email" value="{DATA.contact_email}" oninvalid="setCustomValidity( nv_email )" oninput="setCustomValidity('')" required="required" oninvalid="setCustomValidity( nv_required )" oninput="setCustomValidity('')" />
						</div>
					</div>
					<div class="form-group">
		...
		<div class="col-md-5">
			...
			<div class="panel panel-default">
				<div class="panel-heading">{LANG.noi_that}</div>
				<div class="panel-body">
					<!-- BEGIN: noi_that -->
						<div class="noi_that">
			...
			<div class="panel panel-default">
				<div class="panel-heading">{LANG.tien_ich}</div>
				<div class="panel-body">
					<!-- BEGIN: tien_ich -->
						<div class="tien_ich">
