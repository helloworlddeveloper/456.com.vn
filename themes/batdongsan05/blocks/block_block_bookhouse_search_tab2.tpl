...
<div class="timkiem_danhmuc content_form_block">
	<form action="#" method="post" class="form-horizontal">
		...
		<ul class="nav nav-tabs" role="tablist">
			<div class="tieude_block"><strong>{LANG.tim_kiem_theodiadiem}</strong></div> 
			<!-- BEGIN: tab -->
