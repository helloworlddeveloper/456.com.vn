...
if (! nv_function_exists('nv_block_search1')) {
    ...
    function nv_block_config_search1($module, $data_block, $lang_block)
    {	
        ...
        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/block_block_bookhouse_search_tab1.tpl')) {
            $block_theme = $global_config['module_theme'];
        } else {
            $block_theme = 'batdongsan05';
        }
		
        $xtpl = new XTemplate('block_block_bookhouse_search_tab1.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
    ...
    function nv_block_config_search_submit1($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    function nv_block_search1($block_config, $module)
    {
        ...
        $themetype = 'block_block_bookhouse_search_tab1.tpl';
...
if (defined('NV_SYSTEM')) {
    ...
    if (isset($site_mods[$module])) {
        ...
        $content = nv_block_search1($block_config, $module);
    }
}
