...
<div class="tabs tabs_bds content_form_block">
	<form action="{NV_BASE_SITEURL}index.php" method="get" class="form-horizontal">
		...
		<ul class="nav nav-tabs" role="tablist">
			...
			<!-- BEGIN: tab -->
			<li role="presentation" class="{TAB.active}"><a href="#block_search_type_tab" aria-controls="block_search_type_tab" role="tab" data-toggle="tab" data-catid="{stt}" data-index="{TAB.index}">{TAB.title}</a></li>
			<!-- END: tab -->
		</ul>
