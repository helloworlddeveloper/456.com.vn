<!-- BEGIN: main -->
<div class="wraper">
<div style="display:none" class="tabs tabs_bds11 content_form_block">
	<form action="#" method="post" class="form-horizontal">
		...
		<input type="hidden" name="catid" id="tab_index" value="{SEARCH.catid}" />
	
		<div class="tab-content1">
			<div role="tabpanel" id="block_search_type_tab">
							...
							<div class="row">
								...
								<div class="col-md-8">
									...
									<div class="phong_ngu_s row">
										<div class="col-xs-10 col-sm-10 col-md-12">Chọn phòng khách </div>
										<div class="col-xs-14 col-sm-14 col-md-12 sophongkhach">
											<input type="hidden" name="phong_khach"/>
											<span value="1">1p</span><span value="2">2p</span><span value="3">3p</span><span value="4">+4p</span>
										</div>
									</div>
									<div class="phong_tam_s row">
										<div class="col-xs-10 col-sm-10 col-md-12">Chọn phòng tắm </div>
