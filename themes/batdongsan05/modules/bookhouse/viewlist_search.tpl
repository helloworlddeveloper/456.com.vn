...
<div class="content_block_tin_search">
	...
	<div class="item_blocktin row">
		<div class="tieude_blocktin_mobile">
			<a style="color:{DATA.color}" title="{DATA.title}" href="{DATA.link}">{DATA.title}</a>
			<!-- BEGIN: image_mobile -->	
			<img src="{image_block}"/>
			<!-- END: image_mobile -->	
		...
		<div class="nd_blocktin col-xs-16 col-sm-18 col-md-19">
			<div class="tieude_blocktin">
				<a style="color:{DATA.color}" title="{DATA.title}" href="{DATA.link}">{DATA.title}</a>
				<!-- BEGIN: image -->	
				<img src="{image_block}"/>
				<!-- END: image -->	
			</div>
			<div class="gia_blocktin">
				<img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/nha-dat/icon-gia.png"/>
			...
			<div class="row content_vt_tg">
				<div class="vitri_blocktin col-sm-14 col-md-18"><img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/nha-dat/icon-dia-chi.png"/>
					{LANG.items_location}: {DATA.location}
				</div>
