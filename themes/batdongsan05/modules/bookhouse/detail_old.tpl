...
<script>
		...
		geocodeAddress(geocoder, map, '110 nguyễn thái sơn, gò vấp', '{IMAGE}','{LINK_DIADIEM}');
      }	
	  
      function geocodeAddress(geocoder, resultsMap, value, image, link) {
...
<div id="map" class="viewmap_detail" style="width:100%;height:400px;"></div>
