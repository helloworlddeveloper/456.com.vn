...
<div id="nv-block-login" class="text-center">
	...
	<!-- BEGIN: allowuserreg2 -->
	<button type="button" class="register btn btn-sm btn_bds" onclick="modalShowByObj('#guestReg_{BLOCKID}', 'recaptchareset')">
		{GLANG.register}
	</button> /
	<button type="button" class="login btn btn-sm btn_bds" onclick="modalShowByObj('#guestLogin_{BLOCKID}', 'recaptchareset')">
		{GLANG.signin}
	</button>
	<!-- END: allowuserreg2 -->
