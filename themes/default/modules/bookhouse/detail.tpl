...
<div id="detail">
	...
	<!-- BEGIN: project -->
	<p>
		<strong>{LANG.project}:</strong> <a target="_blank" href="{DATA.project.link}" title="{DATA.project.title}">{DATA.project.title}</a>
	</p>
	<!-- END: project -->
	<!-- BEGIN: way -->
	<p>
	...
	<p>
		<strong>{LANG.price}:</strong> <span class="price"><!-- BEGIN: price -->{DATA.price}<!-- END: price --><!-- BEGIN: contact -->{LANG.contact}<!-- END: contact --></span>
	</p>
